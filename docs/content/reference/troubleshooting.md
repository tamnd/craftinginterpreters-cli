...
Most of these come down to network reality or how craftinginterpreters serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

craftinginterpreters rate-limits like any public site. ci already paces
...
Where a surface is gated, ci reads a cookie or token you supply
...
`ci`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ci actually did
